    ...
    public partial class MainForm : Form {
        ...
        private void FilterForm_FilterCompleted(object sender, FilterCompletedEventArgs e) {
            ...
            switch (e.Filter) {
                ...
                case Filter.Watercolor:
                    msg = String.Format(Resources.WatercolorEndMsg, e.Duration.TotalSeconds, Resources.SecondsStr);
                    break;
        ...
        private void OperationForm_OperationCompleted(object sender, OperationCompletedEventArgs e) {
            ...
            switch (e.Operation) {
                ...
                case Operation.RollingBall:
                    ...
                    log(outputMsg);
                    ImgPicBox.Refresh();
                    msg = String.Format(Resources.RollingBallEndMsg, e.Duration.TotalSeconds, Resources.SecondsStr);
                    break;
